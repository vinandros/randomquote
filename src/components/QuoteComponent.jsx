    ...
    return (
      <div id="quote">
        <div id="footer-flex">
          ...
          >
            <img id="tweet-quote-img" src={logo} alt="Twiter" />
          </a>
          <button id="new-quote" className="btn" onClick={this.handleOnClick}>
            <p className="textDecoration">New Quote</p>
          </button>
        </div>
        {!pending ? (
          <Fragment>
            <div id="text" className="fade">
              <p className="textDecoration">{'"' + quote + '"'}</p>
            </div>
        ...
        <p id="note">
          Note: please disable secure connection to enable quote request.
        </p>
      </div>
    );
  }
